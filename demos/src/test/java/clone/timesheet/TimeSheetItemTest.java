...
class TimeSheetItemTest {
    ...
    void testCreateWithData() {
        ...
        assertEquals(LocalDateTime.of(2017, 4, 24, 8, 0), timeSheetItem.getFromDate());
        assertEquals(LocalDateTime.of(2017, 4, 24, 17, 30), timeSheetItem.getToDate());
    }
    ...
    void testCreateBasedOnTimeSheetItem() {
        ...
        assertEquals(LocalDateTime.of(2017, 4, 24, 8, 0), anotherTimeSheetItem.getFromDate());
        assertEquals(LocalDateTime.of(2017, 4, 24, 17, 30), anotherTimeSheetItem.getToDate());

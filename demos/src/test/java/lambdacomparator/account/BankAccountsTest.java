...
class BankAccountsTest {
    ...
    void testListBankAccountsByBalance() {
        ...
        assertEquals(90.0, sorted.get(0).getBalance(), 0.001);
        assertEquals(105.0, sorted.get(3).getBalance(), 0.001);
    }
    ...
    void testListBankAccountsByBalanceDesc() {
        ...
        assertEquals(105.0, sorted.get(1).getBalance(), 0.001);
        assertEquals(90.0, sorted.get(3).getBalance(), 0.001);
        assertEquals(-102.0, sorted.get(4).getBalance(), 0.001);
    }
